  ...
  <body>
    ...
    <div class="collapse navbar-collapse" id="navbar">
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link" href="<?php echo $base_path;?>/usersShared/index.php?type=vistor&status=login">Login</a>
        </li>
        <li class="nav-item d-sm-none d-md-none d-lg-block">
          <a class="nav-link disabled">|</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo $base_path;?>/usersShared/index.php?type=vistor&status=register">Register</a>
        </li>
      </ul>
    </div>
  </nav>
